...
libGame.a: game.o timeWizard.o renderFrame.o player.o inputMap.o actor.o
	ar rs $@ $^
...
actor.o: $(GD)Actor/actor.c $(GD)Actor/actor.h $(GD)Actor/actorList.c $(GD)Actor/actorList.h
	gcc $(CFLAGS) -c $(GD)Actor/actor.c -o $@
